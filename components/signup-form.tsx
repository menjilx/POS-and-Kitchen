 ...
 repeating-linear-gradient(
      ...
      `,
        ...
        <div className="relative isolate flex flex-col items-center gap-2">
          <Link href="/" className="absolute -top-12 left-0 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
          ...
          <Button type="button" className="mt-6 w-full gap-3" variant="outline">
            <GoogleLogo />
