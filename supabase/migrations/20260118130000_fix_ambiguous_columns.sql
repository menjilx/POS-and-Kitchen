-- Fix ambiguous column error (42702) in get_ingredient_cost_trends function
-- This was caused by missing table aliases in the ingredient_stats CTE

-- Re-create the function with proper column aliases
